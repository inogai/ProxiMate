...
import '../screens/scanned_user_detail_screen.dart';
...
class _QRScannerWidgetState extends State<QRScannerWidget> {
  ...
  Future<void> _processQRCode(String code) async {
    ...
    try {
      ...
      if (targetUserId != null && targetUserId.isNotEmpty) {
        // Navigate to the peer detail screen
        if (mounted) {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) =>
                  ScannedUserDetailScreen(userId: targetUserId),
            ),
          );
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: _buildMobileScanner(context, currentProfile));
  }
      ...
      children: [
        ...
        Stack(
          children: [
            ...
            if (!_isScanning) Container(color: Colors.black54),
          ],
        ),
