...
Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(ConnectionCreateRequest.serializer)
      ..add(ConnectionRead.serializer)
      ..add(ConnectionRequestRequest.serializer)
      ..add(ConnectionRespondRequest.serializer)
      ..add(HTTPValidationError.serializer)
      ..add(InvitationRespondRequest.serializer)
      ..add(LocationCreate.serializer)
      ..add(LocationRead.serializer)
      ..add(LocationUpdate.serializer)
      ..add(TwoHopConnection.serializer)
